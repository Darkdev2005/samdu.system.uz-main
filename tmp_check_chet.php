...
$code = 'TEST_CHET_' . date('His');
$baseName = 'Test Chet Tili';
$variantNames = ['Test Chet Variant A', 'Test Chet Variant B'];
$izoh = 'codex chet test';
...
if ($base_id === 0) { echo "Failed to create base chet fan\n"; exit(1); }
